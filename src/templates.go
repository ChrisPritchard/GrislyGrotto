...
<form method="POST">
    ...
    <div class="editor-help">
        ...
        <br />Basically type normally, use _text_ or *text* for bold, __text__ for italic,
        <br /> - to create bullet points etc. Its faily intuitive.
        <br />Raw HTML is raw HTML, be aware.
    </div>
