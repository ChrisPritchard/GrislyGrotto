// generated by go generate and embedTemplates.go; DO NOT EDIT
// 2020-06-13T16:33:26+12:00
package main
...
<p>
v17 is the first version to be built in the language Go, and a reasonably anaemic use of the language too: aside from a couple of libraries to use Sqlite and markdown, I am using nothing but the packages shipped with the core install (mainly http, database/sql and template/html). The previous two versions of the website were in F# (though in truth largely the same codebase), a language that is one of my favourites for its simplicity and functional style. However, I have really enjoyed building this version in Go.
</p>
<p>
...
<html>
    ...
    <body>
        <canvas class="background-animation" id="background-animation"></canvas>
                    ...
                    <div>
                        <form method="POST" action="/save-theme">
                            ...
                            <select type="checkbox" id="site-theme">
                                ...
                                <option value="purple-black">Theme: Twilight Shadows</option>
    ...
    {{ range .Years }}
        <li>
            ...
            <ul class="months">
                {{ range .Months }}
                    <li>
                        <a href="/archives/{{ .Month }}/{{ .Year }}">{{ .Month }} ({{ .Count }})</a>
                    </li>
                {{ end }}
            </ul>
        </li>
