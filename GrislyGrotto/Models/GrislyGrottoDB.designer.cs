...
namespace GrislyGrotto.Models
{
    ...
    partial void DeleteQuote(Quote instance);
		...
		public GrislyGrottoDBDataContext() : 
				base(global::System.Configuration.ConfigurationManager.ConnectionStrings["GrislyGrottoDBConnectionString"].ConnectionString, mappingSource)
		{
			OnCreated();
		}
		
		public GrislyGrottoDBDataContext(string connection) : 
