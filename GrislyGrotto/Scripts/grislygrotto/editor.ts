    ...
    export class Editor {
        ...
        setupImageUpload($fileControl: JQuery, $uploadLink: JQuery, $uploadingStatus: JQuery) {
            ...
            $uploadLink.click(function () {
                ...
                var file = (<HTMLInputElement>fileControl).files[0];
                ...
                $.ajax($(this).attr('href'), {
                    ...
                    success: function (path) {
                        ...
                        if (_this.isHtml)
                            _this.$editorDiv.text(_this.$editorDiv.text() + imageHtml);
                        else
                            _this.$editorDiv.append(imageHtml);
