...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt" exclude-result-prefixes="msxsl" >
  ...
  <xsl:template match="userbox">
    <div xmlns="http://www.w3.org/1999/xhtml" class="sidebar">
      <form method="post">
        <xsl:choose>
          <xsl:when test="/page/author/@logged">
            <h3>
              Welcome <xsl:value-of select="/page/author/@logged" />
            </h3>
            <ul type="none">
              <li>
    ...
    <div class="sidebar" xmlns="http://www.w3.org/1999/xhtml">
      <ul class="lined" type="none">
        <xsl:for-each select="authorlink">
          <li class="lined">
            <a class="author" href="?author={@name}">
    ...
    <div class="sidebar" xmlns="http://www.w3.org/1999/xhtml">
      ...
      <ul type="none">
        <xsl:for-each select="/page/recentblogs/recentblog">
          <li>
            <a href="?author={/page/author/@name}&amp;blog={@title}">
              <xsl:value-of select="@title" />
            </a>
          </li>
        </xsl:for-each>
    ...
    <div class="sidebar" xmlns="http://www.w3.org/1999/xhtml">
      ...
      <ul type="none">
        <xsl:for-each select="/page/history/month">
          <li>
            <a href="?author={/page/author/@name}&amp;month={@link}">
              <xsl:value-of select="@text" />
            </a>
          </li>
        </xsl:for-each>
  ...
  <xsl:template match="comments">
    <div xmlns="http://www.w3.org/1999/xhtml">
      ...
      <form method="post" action="?author={/page/author/@name}&amp;blog={/page/blogs/blog/@title}#comments" >
        <h3>
          Post a comment
        </h3>
        <ul type="none">
